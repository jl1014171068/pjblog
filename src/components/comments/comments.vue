            ...
            <div class="commentsTop">
                <div class="control_comments">
                    ...
                    <div class="share">
                        ...
                        <ul id="bdshare" class="bdsharebuttonbox"  data-tag="share_1" data="{'text':'这里写入您想要自定义的分享内容B'}">
                            <li>
                                <a href="#" data-cmd="tsina" title="分享到新浪" class="iconfont icon-xinlangjianying"></a>
                            </li>
                            <li>
                                <a href="#" data-cmd="douban" title="分享到豆瓣" class="iconfont icon-douban"></a>
                            </li>
                            <li>
                                <a href="#" data-cmd="huaban" title="分享到花瓣" class="iconfont icon-huaban"></a>
                            </li>
                            <li>
                                <a href="#" data-cmd="tqq" title="分享到QQ" class="iconfont icon-qq"></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="content_commtents">
                    <div class="input_comments" :class='focusFlag?"focus":""'>
                        ...
                        <div class="send">
                        <button class='iconfont icon-fasong' @click.prevent='send'></button>
