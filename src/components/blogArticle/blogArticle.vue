        ...
        <div class="content_lm">
            ...
            <div class="nav">
                <div class="top">
                	...
                	<span class="link prev"  @click="prevPage(content.prev_slug)"  :disabled='prevDisabld' :class="content.prev_slug===null?'':'active'">上一篇文章</span>
                ...
                <div class="bottom">
                	<div class="img">
                		<img v-lazy="content.qrcode" width="128" height="128">
                	</div>
